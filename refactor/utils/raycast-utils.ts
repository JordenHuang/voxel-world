...
import { BlockUtils, WorldUtils } from "./index";
...
export class Raycast {
  public static cast(origin: vec3, direction: vec3, maxDistance: number = 5, getBlockFn: (worldX: number, worldY: number, worldZ: number) => number): RaycastResult {
